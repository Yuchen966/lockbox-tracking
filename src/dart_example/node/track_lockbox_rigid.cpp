...
double factor = 0.2;
static const vector<float> initial_pose = {0.02264+factor, -0.09376+factor, 0.5405+factor, 1.966, -0.3219, 0.1711};
...
//            glutSolidCone(0.0125,0.02,10,1);
        ...
        if (pangolin::Pushed(stepVideo) || trackFromVideo || pangolinFrame == 1) {
            ...
            //             sqrt(pow(initial_pose_test[1] - true_pose[1], 2)) +
            //             sqrt(pow(initial_pose_test[2] - true_pose[2], 2));
            //     }
            // }
        } else {
            // for (int i=0; i<10; ++i) {
