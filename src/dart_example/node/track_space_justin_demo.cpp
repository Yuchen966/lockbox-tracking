...
int main() {
    ...
    const std::string videoLoc = "/home/yuchen/Documents/dart/dart_example_ros/video";
    ...
    // dart::ImageDepthSource<ushort,uchar3> * depthSource = new dart::ImageDepthSource<ushort,uchar3>();
    depthSource->initialize(//"/home/yuchen/Documents/lockbox_ws/src/dart_example/video/depth",
                            "/home/yuchen/Documents/lockbox_ws/models/lockbox1/depth_flip_const_floats",
                            dart::IMAGE_PNG,
...
//                            true,videoLoc+"/color",dart::IMAGE_PNG,320,240);
    std::cout << "Successful in initialization" << std::endl;
...
//                     objObsSdfOffset);
    ...
    tracker.addModel("/home/yuchen/Documents/dart/dart_example_ros/models/spaceJustin/spaceJustinHandLeft.xml",
    ...
    // set up potential intersections
    {
        ...
        int * selfIntersectionMatrix = dart::loadSelfIntersectionMatrix("/home/yuchen/Documents/dart/dart_example_ros/models/spaceJustin/justinIntersection.txt",tracker.getModel(0).getNumSdfs());
    ...
    loadReportedJointAnglesAndContacts("/home/yuchen/Documents/dart/dart_example_ros/video/reportedJointAngles.txt","/home/yuchen/Documents/dart/dart_example_ros/video/reportedContacts.txt",
        ...
        case DebugObsDepth:
            {
                ...
                // const float * depth = depthSource->getDepth();
